...
# df = pd.read_csv('./GOOG.csv',index_col = ['Date'] ,usecols = ['Date', 'Adj Close'], parse_dates=True)
...
apple_stock = pd.read_csv('./GOOG.csv',index_col = ['Date'] ,usecols = ['Date', 'Adj Close'], parse_dates=True)

# We load the Amazon stock data into a DataFrame
amazon_stock = pd.read_csv('./AAPL.csv',index_col = ['Date'] ,usecols = ['Date', 'Adj Close'], parse_dates=True)
